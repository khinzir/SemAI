...
#     SearchIndex, SimpleField, SearchableField, VectorSearchField,
...
#             ],
#             profiles=[
#                 VectorSearchProfile(name="vector-profile", algorithm="hnsw-config")
#             ]
#         )
#
...
class SearchClientManager:
    ...
    def create_index(self):
        ...
        #     ],
        #     profiles=[
        #         VectorSearchProfile(name="vector-profile", algorithm_name="hnsw-config")
        #     ]
        # )
        vector_search = VectorSearch(
            algorithms=[
